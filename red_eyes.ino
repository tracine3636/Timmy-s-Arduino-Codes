...
void loop()
{
   Tft.drawVerticalLine(60,95,150,CYAN); 
    ...
    Tft.fillCircle(150, 100, 20,RED);     
     
    Tft.fillCircle(150, 230, 20,RED);  
 ...
 delay (100);
    ...
    Tft.fillCircle(150, 120, 20,RED);     
     
    Tft.fillCircle(150, 250, 20,RED);  
 ...
 delay (300);   
    ...
    Tft.fillCircle(150, 80, 20,RED);     
     
    Tft.fillCircle(150, 210, 20,RED);  
